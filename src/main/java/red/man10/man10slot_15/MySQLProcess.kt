...
class MySQLCreate(private val pl: Man10Slot_15): Thread() {
...
class MySQLSave(val pl: Man10Slot_15, val p: Player,val slot_name: String,val win_name: String,val win_level: Int,val inmoney: Double,val outmoney: Double,val table_num: Int,val table_count: Int): Thread() {
...
class getData(val pl: Man10Slot_15, val key: String, val sender: CommandSender): Thread(){
